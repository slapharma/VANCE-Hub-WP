...
<!-- Modals & Scripts -->
    ...
    <?php $premium_section_bg = vance_get_theme_mod('vance_premium_section_bg', '#0f172a'); ?>
    <section class="premium-subscribe-section" style="background: <?php echo esc_attr($premium_section_bg); ?>; padding: 100px 0; color: white;">
