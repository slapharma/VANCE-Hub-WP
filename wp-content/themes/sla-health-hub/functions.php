...
<p>By using VANCE-Ai you accept that it is for general information only. <a href="%s" target="_blank" rel="noopener">Read the full medical disclaimer</a>.</p>', 'sla-health-hub' ),
    ...
    $intro_defaults = array(
        'title'    => __( 'Demystify Your Health Journey', 'sla-health-hub' ),
        'subtitle' => __( 'VANCE-Ai helps you understand complex medical terms instantly as you read.', 'sla-health-hub' ),
        'feat1_t'  => __( 'Highlight to explain', 'sla-health-hub' ),
        'feat1_d'  => __( 'Get clear, instant explanations for any medical term.', 'sla-health-hub' ),
    ...
    return array(
        ...
        'i18n'          => array(
            ...
            'notePill'        => __( 'Add to note', 'sla-health-hub' ),
            'noteTitle'       => __( 'Add highlight to a note', 'sla-health-hub' ),
            'noteExisting'    => __( 'Your notes', 'sla-health-hub' ),
            'noteLoading'     => __( 'Loading your notes…', 'sla-health-hub' ),
            'noteListFailed'  => __( 'Could not load your notes.', 'sla-health-hub' ),
            'noteNone'        => __( 'You have no notes yet. Create your first one below.', 'sla-health-hub' ),
            'noteNewLabel'    => __( 'Or create a new note', 'sla-health-hub' ),
            'noteNewHint'     => __( 'Note title', 'sla-health-hub' ),
            'noteCreate'      => __( 'Create note', 'sla-health-hub' ),
            'noteSaving'      => __( 'Saving…', 'sla-health-hub' ),
            'noteSaved'       => __( 'Added to your note.', 'sla-health-hub' ),
            'noteOpen'        => __( 'Open note', 'sla-health-hub' ),
            'noteFailed'      => __( 'Could not save to your note. Please try again.', 'sla-health-hub' ),
            'noteSignedOut'   => __( 'Register for FREE to save highlights straight into your own notes.', 'sla-health-hub' ),
            'noteFrom'        => __( 'From', 'sla-health-hub' ),
            'close'           => __( 'Close', 'sla-health-hub' ),
            ...
            'introRegister'   => __( 'New here? Register for free', 'sla-health-hub' ),
...
function vance_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control( 'vance_askai_intro_popup', array(
        ...
        'description' => __( 'Show a short popup on articles explaining how VANCE-Ai can help the reader understand what they are about to read.', 'sla-health-hub' ),
        'section'     => 'vance_askai_settings',
        'type'        => 'checkbox',
    ) );
    ...
    $wp_customize->add_control( 'vance_askai_intro_frequency', array(
        'label'       => __( 'Popup: how often', 'sla-health-hub' ),
        'description' => __( 'How often one visitor may see the popup. Counted per browser.', 'sla-health-hub' ),
        'section'     => 'vance_askai_settings',
        'type'        => 'select',
        'choices'     => array(
    ...
    $wp_customize->add_control( 'vance_askai_intro_per_day', array(
        'label'       => __( 'Popup: times per day', 'sla-health-hub' ),
        'description' => __( 'Only used when "How often" is set to a number of times per day.', 'sla-health-hub' ),
        'section'     => 'vance_askai_settings',
        'type'        => 'number',
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'vance_askai_intro_image', array(
        'label'       => __( 'Popup: image', 'sla-health-hub' ),
        'description' => __( 'Shown in the right-hand column of the popup. Leave empty to show a branded placeholder. Landscape or square images around 600x600 work best.', 'sla-health-hub' ),
        'section'     => 'vance_askai_settings',
    ) ) );
    ...
    $wp_customize->add_control( 'vance_askai_intro_title', array(
        'label'       => __( 'Popup: heading', 'sla-health-hub' ),
        'description' => __( 'The large headline in the article intro popup.', 'sla-health-hub' ),
        'section'     => 'vance_askai_settings',
        'type'        => 'text',
    ) );
    ...
    $wp_customize->add_control( 'vance_askai_intro_subtitle', array(
        'label'   => __( 'Popup: subtitle', 'sla-health-hub' ),
        'section' => 'vance_askai_settings',
        'type'    => 'textarea',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'vance_askai_intro_logo', array(
        'label'       => __( 'Popup: logo', 'sla-health-hub' ),
        'description' => __( 'Shown top-left of the popup. Leave empty to use the site logo.', 'sla-health-hub' ),
        'section'     => 'vance_askai_settings',
    ) ) );
    ...
    $wp_customize->add_control( 'vance_askai_intro_feat1_title', array(
        'label'   => __( 'Popup: feature 1 title', 'sla-health-hub' ),
        'section' => 'vance_askai_settings',
        'type'    => 'text',
    ) );
    ...
    $wp_customize->add_control( 'vance_askai_intro_feat1_desc', array(
        'label'   => __( 'Popup: feature 1 description', 'sla-health-hub' ),
        'section' => 'vance_askai_settings',
        'type'    => 'textarea',
    ) );
    ...
    $wp_customize->add_control( 'vance_askai_intro_feat2_title', array(
        'label'   => __( 'Popup: feature 2 title', 'sla-health-hub' ),
        'section' => 'vance_askai_settings',
        'type'    => 'text',
    ) );
    ...
    $wp_customize->add_control( 'vance_askai_intro_feat2_desc', array(
        'label'   => __( 'Popup: feature 2 description', 'sla-health-hub' ),
        'section' => 'vance_askai_settings',
        'type'    => 'textarea',
    ) );
    ...
    $wp_customize->add_control( 'vance_askai_intro_lead', array(
        'label'       => __( 'Popup: button lead-in', 'sla-health-hub' ),
        'description' => __( 'The prompt shown directly above the button.', 'sla-health-hub' ),
        'section'     => 'vance_askai_settings',
        'type'        => 'text',
    ) );
    ...
    $wp_customize->add_control( 'vance_askai_intro_body', array(
        'label'       => __( 'Popup: body text (legacy)', 'sla-health-hub' ),
        'description' => __( 'No longer shown in the redesigned popup. Use the subtitle and feature fields above instead.', 'sla-health-hub' ),
        'section'     => 'vance_askai_settings',
        'type'        => 'textarea',
    ) );
