...
<main id="main-content">
    ...
    ?>
    <section class="vance-about-hero" style="padding: 72px 0 116px; min-height: 332px; display: flex; align-items: flex-start; <?php echo $hero_bg_style; ?> position: relative; overflow: hidden;">
