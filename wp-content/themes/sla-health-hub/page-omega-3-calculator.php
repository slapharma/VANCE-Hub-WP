...
$vance_tool_title_color    = vance_get_theme_mod( 'vance_tool_omega_name_color', '' );
$vance_tool_title_size     = vance_get_theme_mod( 'vance_tool_omega_name_size', 56 );
$vance_tool_subtitle_color = vance_get_theme_mod( 'vance_tool_omega_subtitle_color', '' );
$vance_tool_subtitle_size  = vance_get_theme_mod( 'vance_tool_omega_subtitle_size', 19 );
