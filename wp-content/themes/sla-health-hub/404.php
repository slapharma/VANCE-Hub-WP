...
<div class="container" style="padding: 100px 20px; text-align: center;">
    ...
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="btn btn-primary" style="display: inline-block; padding: 14px 32px; font-size: 15px; font-weight: 700; border-radius: 10px; text-decoration: none;">Home</a>
</div>
