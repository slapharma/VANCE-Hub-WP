...
$vance_tool_badge          = vance_get_theme_mod( 'vance_tool_blood_badge', 'Lab Results' );
$vance_tool_badge_bg       = vance_get_theme_mod( 'vance_tool_blood_badge_bg', '' );
$vance_tool_badge_color    = vance_get_theme_mod( 'vance_tool_blood_badge_color', '' );
$vance_tool_title_color    = vance_get_theme_mod( 'vance_tool_blood_name_color', '' );
$vance_tool_title_size     = vance_get_theme_mod( 'vance_tool_blood_name_size', 56 );
$vance_tool_subtitle_color = vance_get_theme_mod( 'vance_tool_blood_subtitle_color', '' );
$vance_tool_subtitle_size  = vance_get_theme_mod( 'vance_tool_blood_subtitle_size', 19 );
