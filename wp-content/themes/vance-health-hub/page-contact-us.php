            ...
            <div class="vcontact-grid" style="display: grid; grid-template-columns: minmax(0,1fr) minmax(0,1.4fr); gap: 60px; align-items: start;">
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 20px; margin-bottom: 40px;">
                        ...
                        <div style="display: flex; gap: 16px; align-items: flex-start; background: white; padding: 20px 24px; border-radius: var(--radius-surface, 24px); box-shadow: 0 1px 6px rgba(0,0,0,.06);">
                            <div style="flex-shrink: 0; width: 44px; height: 44px; border-radius: var(--radius-control, 10px); background: <?php echo $d['color']; ?>1a; display: flex; align-items: center; justify-content: center;">
                    ...
                    <div>
                        ...
                        <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                            ...
                            <a href="<?php echo esc_url( $s['url'] ); ?>" target="_blank" rel="noopener noreferrer"
                               ...
                               style="display: inline-flex; align-items: center; justify-content: center; width: 44px; height: 44px; border-radius: var(--radius-control, 10px); background: white; box-shadow: 0 1px 6px rgba(0,0,0,.1); color: var(--secondary-color); transition: transform .15s, box-shadow .15s;"
                ...
                <div style="background: white; border-radius: var(--radius-surface, 24px); padding: 48px 44px; box-shadow: 0 4px 32px rgba(10,25,41,.1);">
                    ...
                    <div style="background: #fef2f2; border: 1px solid #fecaca; border-radius: var(--radius-surface, 24px); padding: 14px 18px; margin-bottom: 24px; color: #dc2626; font-size: 14px;">
                    ...
                    <form method="post" action="<?php echo esc_url( get_permalink() ); ?>#contact-form" id="contact-form">
                        ...
                        <div id="contact-form-client-error" style="display:none; background: #fef2f2; border: 1px solid #fecaca; border-radius: var(--radius-surface, 24px); padding: 14px 18px; margin-bottom: 24px; color: #dc2626; font-size: 14px;"></div>
                        ...
                        <div class="vcontact-name-email-grid" style="display: grid; grid-template-columns: minmax(0,1fr) minmax(0,1fr); gap: 20px; margin-bottom: 20px;">
                            <div>
                                ...
                                <input type="text" id="contact_name" name="contact_name" required
                                       ...
                                       style="width: 100%; padding: 13px 16px; border: 1.5px solid #e2e8f0; border-radius: var(--radius-field, 16px); font-size: 15px; color: var(--secondary-color); background: #f8fafc; transition: border-color .2s; outline: none; box-sizing: border-box;"
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <select id="contact_subject" name="contact_subject"
                                    style="width: 100%; padding: 13px 16px; border: 1.5px solid #e2e8f0; border-radius: var(--radius-field, 16px); font-size: 15px; color: var(--secondary-color); background: #f8fafc; transition: border-color .2s; outline: none; box-sizing: border-box; appearance: none; cursor: pointer;"
                                    onfocus="this.style.borderColor='var(--primary-color)';this.style.background='white';"
                                    onblur="this.style.borderColor='#e2e8f0';this.style.background='#f8fafc';">
                        ...
                        <div style="margin-bottom: 28px;">
                            ...
                            <textarea id="contact_message" name="contact_message" required rows="6"
                                      ...
                                      style="width: 100%; padding: 13px 16px; border: 1.5px solid #e2e8f0; border-radius: var(--radius-field, 16px); font-size: 15px; color: var(--secondary-color); background: #f8fafc; transition: border-color .2s; outline: none; box-sizing: border-box; resize: vertical; font-family: inherit; line-height: 1.6;"
                                      onfocus="this.style.borderColor='var(--primary-color)';this.style.background='white';"
                        ...
                        <button type="submit" name="vance_contact_submit" value="1" class="btn btn-primary"
                                style="width: 100%; padding: 16px; font-size: 16px; font-weight: 700; border: none; border-radius: var(--radius-control, 10px); cursor: pointer; letter-spacing: 0.3px;">
                            Send Message
