        ...
        <div class="container">
            ...
            <div class="grid-2 resource-grid">
                ...
                <div class="evidence-pillar-card" style="display: flex; gap: 20px; padding: 32px; background: <?php echo esc_attr( $evd_card_bg ); ?>; border-radius: var(--radius-lg); box-shadow: var(--shadow-sm);">
                    <div class="evidence-pillar-icon" style="flex-shrink: 0; width: 56px; height: 56px; background: linear-gradient(135deg, <?php echo esc_attr( $pillar_colors[ $i ][0] ); ?>, <?php echo esc_attr( $pillar_colors[ $i ][1] ); ?>); border-radius: var(--radius-control, 6px); display: flex; align-items: center; justify-content: center;">
