                        ...
                        <div class="d-card d-col-4">
                            ...
                            <?php else : ?>
                                ...
                                <?php if ( $vance_dash_next_row ) : ?>
                                    <a href="<?php echo esc_url( $vance_dash_next_row['permalink'] ); ?>" style="display:block; background:#F0FDFA; border-radius:var(--radius-control, 6px); padding:10px 12px; font-size:12px; color:#0F172A; text-decoration:none;">
                ...
                case 'health-profile':
                    ...
                    <style>
                        ...
                        .vance-mc-pill {
                            ...
                            border-radius:var(--radius-pill, 999px); border:1px solid currentColor;
                        }
                        .vance-mc-close {
