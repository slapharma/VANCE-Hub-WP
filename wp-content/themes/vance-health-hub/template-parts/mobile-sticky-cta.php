...
?>
<div class="vance-sticky-cta" data-vsc-key="<?php echo esc_attr( $vsc_key ); ?>" role="region" aria-label="<?php esc_attr_e( 'Call to action', 'vance-health-hub' ); ?>" hidden>
    ...
    <button class="vsc-dismiss" type="button" aria-label="<?php esc_attr_e( 'Dismiss', 'vance-health-hub' ); ?>">
