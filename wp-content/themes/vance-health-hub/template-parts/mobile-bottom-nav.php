...
?>
<nav class="vance-bottom-nav" aria-label="<?php esc_attr_e( 'Primary mobile navigation', 'vance-health-hub' ); ?>">
    <a class="vbn-tab<?php $vbn_active( $vbn_is_home ); ?>" href="<?php echo esc_url( $vbn_home ); ?>">
        ...
        <span class="vbn-label"><?php esc_html_e( 'Home', 'vance-health-hub' ); ?></span>
    </a>
    ...
    <a class="vbn-tab<?php $vbn_active( $vbn_is_dash ); ?>" href="<?php echo esc_url( $vbn_dashboard ); ?>">
        ...
        <span class="vbn-label"><?php esc_html_e( 'Dashboard', 'vance-health-hub' ); ?></span>
    </a>
    <button class="vbn-tab vbn-more-toggle" type="button" aria-expanded="false" aria-controls="vbn-more-sheet">
        ...
        <span class="vbn-label"><?php esc_html_e( 'More', 'vance-health-hub' ); ?></span>
    </button>
</nav>

<div class="vbn-sheet-backdrop" hidden></div>
<div id="vbn-more-sheet" class="vbn-sheet" role="dialog" aria-modal="true" aria-label="<?php esc_attr_e( 'More navigation', 'vance-health-hub' ); ?>" hidden>
    ...
    <ul class="vbn-sheet-links">
        ...
        <?php if ( is_user_logged_in() ) : ?>
            <li><a href="<?php echo esc_url( wp_logout_url( home_url( '/' ) ) ); ?>"><?php esc_html_e( 'Sign Out', 'vance-health-hub' ); ?></a></li>
        <?php else : ?>
            <li><a href="<?php echo esc_url( home_url( '/login/?tab=signup' ) ); ?>"><?php esc_html_e( 'Join for Free', 'vance-health-hub' ); ?></a></li>
            <li><a href="<?php echo esc_url( home_url( '/login/' ) ); ?>"><?php esc_html_e( 'Sign In', 'vance-health-hub' ); ?></a></li>
        <?php endif; ?>
    </ul>
</div>
