		...
		<div class="container">
			...
			<div class="grid-3">
				...
				<div class="patient-tool-card" style="display: flex; gap: 16px; padding: 28px; background: white; border-radius: var(--radius-lg); box-shadow: var(--shadow-sm);">
					<div class="patient-tool-icon" style="flex-shrink: 0; width: 48px; height: 48px; background: linear-gradient(135deg, <?php echo esc_attr( $tool_colors[ $i ][0] ); ?>, <?php echo esc_attr( $tool_colors[ $i ][1] ); ?>); border-radius: var(--radius-surface, 24px); display: flex; align-items: center; justify-content: center;">
		...
		<div class="container">
			...
			<div class="grid-2 resource-grid">
				...
				<div class="hcp-resource-card" style="display: flex; gap: 20px; padding: 32px; background: white; border-radius: var(--radius-lg); box-shadow: var(--shadow-sm);">
					<div class="hcp-resource-icon" style="flex-shrink: 0; width: 56px; height: 56px; background: linear-gradient(135deg, <?php echo esc_attr( $res_colors[ $i ][0] ); ?>, <?php echo esc_attr( $res_colors[ $i ][1] ); ?>); border-radius: var(--radius-surface, 24px); display: flex; align-items: center; justify-content: center;">
