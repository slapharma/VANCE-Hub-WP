...
function vance_tool_widgets_emit_modal_css_once() {
	...
	<style>
		...
		.vance-tw-modal .keyword-input {
			...
			border: 1px solid #E2E8F0; border-radius: var(--radius-surface, 24px);
		...
		.vance-tw-modal .filters-actions {
			...
			border-radius: 0 0 var(--radius-surface, 24px) var(--radius-surface, 24px);
		}
		.vance-tw-modal .vance-tw-btn-go {
			min-height: 46px; padding: 13px 28px;
			background: #008080; color: #ffffff;
			border: none; border-radius: var(--radius-surface, 24px);
		...
		.vance-tw-modal .vance-tw-btn-text {
			...
			border-radius: var(--radius-surface, 24px); cursor: pointer;
