...
function vance_recipe_nutrition_panel_html( $post_id ) {
	...
	ob_start();
	?>
	<div style="background:#fff;border:1px solid #e2e8f0;border-radius:var(--radius-surface, 24px);padding:24px;box-shadow:0 4px 6px -1px rgba(0,0,0,0.05);">
		...
		<div style="display:grid;grid-template-columns:repeat(2,1fr);gap:12px;">
			<?php foreach ( $macros as $m ) :
				...
				?>
				<div style="background:#f8fafc;border-radius:var(--radius-surface, 24px);padding:10px 12px;text-align:center;">
