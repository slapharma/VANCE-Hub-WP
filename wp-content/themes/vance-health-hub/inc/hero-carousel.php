...
function vance_hero_render_slide_content( array $s, $index ) {
	...
	<div style="max-width: 800px;">
		...
		<div class="hero-actions" style="display: flex; gap: 16px; flex-wrap: wrap;">
			<a href="<?php echo esc_url( $s['btn1_link'] ); ?>" <?php echo $btn1_onclick; // phpcs:ignore ?> class="btn btn-primary <?php echo esc_attr( $b1 ); ?>" style="background: <?php echo esc_attr( $s['btn1_bg_color'] ); ?>; color: <?php echo esc_attr( $s['btn1_text_color'] ); ?>; border: 2px solid <?php echo esc_attr( $s['btn1_border_color'] ); ?>; padding: 14px 28px; border-radius: var(--radius-control, 10px); font-weight: 700; text-decoration: none; transition: background 0.2s ease, color 0.2s ease, border-color 0.2s ease;"><?php echo esc_html( $s['btn1_text'] ); ?></a>
			<a href="<?php echo esc_url( $s['btn2_link'] ); ?>" <?php echo $btn2_onclick; // phpcs:ignore ?> class="btn btn-outline <?php echo esc_attr( $b2 ); ?>" style="<?php echo $btn2_bg_decl; // phpcs:ignore ?> color: <?php echo esc_attr( $s['btn2_text_color'] ); ?>; border: 2px solid <?php echo esc_attr( $s['btn2_border_color'] ); ?>; padding: 14px 28px; border-radius: var(--radius-control, 10px); font-weight: 700; text-decoration: none; transition: background 0.2s ease, color 0.2s ease, border-color 0.2s ease;"><?php echo esc_html( $s['btn2_text'] ); ?></a>
		</div>
		<?php endif; ?>
	</div>
	<?php
