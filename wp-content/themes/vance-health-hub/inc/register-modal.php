...
.vance-reg-modal {
    ...
    box-shadow: 0 30px 80px rgba(10,25,41,0.30); position: relative; border-radius: var(--radius-surface, 24px);
...
.vance-reg-modal select {
    ...
    background: #fff; box-sizing: border-box; border-radius: var(--radius-field, 16px);
}
