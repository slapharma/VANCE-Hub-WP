            ...
            <div class="agent-profile">
                <div class="profile-left">
                    ...
                    <div class="agent-info">
                        <h2>VANCE-Ai</h2>
                        <div class="agent-status"><span style="width: 6px; height: 6px; background: #22C55E; border-radius: var(--radius-pill, 999px);"></span> ONLINE & READY</div>
                    </div>
                </div>
                ...
                <p class="chat-autosave-note">
                    ...
                    if ( is_user_logged_in() ) {
                        printf(
                            ...
                            esc_html__( 'Conversations save automatically to %s.', 'vance-health-hub' ),
                            '<a href="' . esc_url( home_url( '/dashboard/?tab=ai-chats' ) ) . '">' . esc_html__( 'your dashboard', 'vance-health-hub' ) . '</a>'
                        );
                    } else {
                        printf(
                            /* translators: %s: login URL */
                            esc_html__( '%s to save your conversations.', 'vance-health-hub' ),
                            '<a href="' . esc_url( home_url( '/login/' ) ) . '">' . esc_html__( 'Log in', 'vance-health-hub' ) . '</a>'
                        );
                    }
                    ?>
                </p>
