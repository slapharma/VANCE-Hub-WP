			...
			<div class="vance-rs-layout" style="display:grid;grid-template-columns:minmax(0,1fr) 300px;gap:40px;align-items:start;">
				...
				<div style="min-width:0;">
					...
					<div class="va-article-disclaimer" style="margin-top:40px;padding:20px 24px;background:#e4def4;border-left:4px solid #8e7dbe;font-size:14px;line-height:1.75;color:#475569;">
						<strong style="color:var(--secondary-color);">For general information only.</strong> This recipe is for general information and is not a substitute for professional medical or dietary advice. Always talk to your GP, dietitian or health team before making significant changes to your diet, especially if you are managing a gastrointestinal condition.
					</div>
				</div>
