...
<article id="post-<?php the_ID(); ?>" <?php post_class('oped-article'); ?> style="margin-top: 0;">
    ...
    <style>
        ...
        .va-article-meta .va-tt-chip { display:inline-block; padding:4px 10px; border-radius:var(--radius-control, 6px); font-size:12px; font-weight:600; text-decoration:none; line-height:1.4; transition:filter .15s ease, background .15s ease, color .15s ease, border-color .15s ease; }
            ...
            <div class="oped-layout">
                ...
                <div class="oped-main-content">
                    ...
                    <div class="va-article-disclaimer" style="margin-top:40px; padding:20px 24px; background:#e4def4; border-left:4px solid #8e7dbe; font-size:14px; line-height:1.75; color:#475569;">
                        <strong style="color:var(--secondary-color);">For general information only.</strong> This article is for general information and is not a substitute for professional medical advice, diagnosis or treatment. It reflects the best available evidence at the time of writing and may not capture the most recent developments. Always talk to your GP, pharmacist or health team before acting on anything you read here, and never disregard professional advice or delay seeking it because of something on this site. Where we mention products from Vance Medical Foods Ltd we identify this clearly.
                ...
                <aside class="oped-sidebar">
                    ...
                    <div class="oped-sidebar-block oped-askai-widget">
                        <h4>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9L12 3z"/><path d="M18 15l.8 2.2L21 18l-2.2.8L18 21l-.8-2.2L15 18l2.2-.8z"/></svg>
                            <?php esc_html_e( 'Ask VANCE-Ai', 'vance-health-hub' ); ?>
                        </h4>
                        <div class="oped-sidebar-content">
                            <p><?php esc_html_e( 'Not sure about a term or a finding in this article? Ask and get it explained using this hub\'s own library.', 'vance-health-hub' ); ?></p>
                            <button type="button" class="oped-askai-widget__btn" data-vance-askai-open>
                                ...
                                <?php esc_html_e( 'Ask about this article', 'vance-health-hub' ); ?>
                            </button>
                            <p class="oped-askai-widget__hint"><?php esc_html_e( 'Tip: highlight any word or passage as you read to ask about it directly.', 'vance-health-hub' ); ?></p>
                        </div>
                    </div>
