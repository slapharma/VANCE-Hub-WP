...
<head>
    ...
    <meta name="description" content="CliftonAI provides pharma-grade nutritional health resources, clinical reviews, and education for healthcare practitioners and patients.">
    <title>CliftonAI. Pharma-Grade Nutritional Health.</title>
    <link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/assets/img/favicon.png">
    <link rel="profile" href="https://gmpg.org/xfn/11">
    <?php wp_head(); ?>
    <?php echo clifton_get_theme_mod( 'clifton_header_scripts' ); ?>
</head>
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
        ...
        <div class="container header-content">
            <div class="logo-area">
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png" alt="CliftonAI" class="site-logo">
                </a>
            </div>
            ...
            <div class="header-actions">
                <div class="header-social-links" style="display: flex; gap: 12px; margin-right: 20px; align-items: center;">
                    ...
                    foreach ( $socials as $key => $svg ) {
                        $link = clifton_get_theme_mod( 'clifton_social_' . $key );
                        if ( $link ) {
