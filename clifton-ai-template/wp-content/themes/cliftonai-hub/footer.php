    ...
    <footer class="main-footer">
        <div class="container">
            <?php 
            $nl_action = clifton_get_theme_mod('clifton_newsletter_action');
            if ($nl_action):
                $nl_head = clifton_get_theme_mod('clifton_newsletter_heading', 'Join the Hub');
                $nl_desc = clifton_get_theme_mod('clifton_newsletter_desc', 'Get the latest clinical reviews and tools.');
            ?>
            ...
            <div class="footer-grid">
                <div class="footer-brand">
                    <?php
                    $f_logo = clifton_get_theme_mod('clifton_footer_logo');
                    $f_text = clifton_get_theme_mod('clifton_footer_brand_text', 'Your IBD Research Centre. Curated clinical research, latest news, health trackers and downloadable resources for both patients and practitioners.');
                    ?>
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" style="display:block; margin-bottom: 24px;">
                        <?php if($f_logo): ?>
                            <img src="<?php echo esc_url($f_logo); ?>" alt="CliftonAI" style="height: 40px;">
                        <?php else: ?>
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png" alt="CliftonAI" style="height: 40px;">
                        <?php endif; ?>
                    </a>
                ...
                <div class="footer-col">
                    <h4><?php echo esc_html(clifton_get_theme_mod('clifton_footer_heading_col1', 'Topics')); ?></h4>
                    <?php
                    wp_nav_menu( array(
                ...
                <div class="footer-col">
                    <h4><?php echo esc_html(clifton_get_theme_mod('clifton_footer_heading_col2', 'For Professionals')); ?></h4>
                    <?php
                    wp_nav_menu( array(
                ...
                <div class="footer-col">
                    <h4><?php echo esc_html(clifton_get_theme_mod('clifton_footer_heading_col3', 'For Patients')); ?></h4>
                    <?php
                    wp_nav_menu( array(
            ...
            <div class="footer-bottom">
                <div class="copyright"><?php echo esc_html(clifton_get_theme_mod('clifton_footer_copyright', '© ' . date('Y') . ' CliftonAI Solutions Ltd. All rights reserved.')); ?></div>
                <div class="footer-links">
                    <a href="https://cliftonai.com/privacy-policy/">Privacy Policy</a>
                    <a href="https://cliftonai.com/terms-of-use/">Terms of Use</a>
                    <a href="https://cliftonai.com/cookie-policy-uk/">Cookie Policy</a>
                </div>
    ...
    <div id="guest-save-modal" class="infographic-modal">
        ...
        <div class="modal-content" style="max-width: 450px; background: white; padding: 40px; border-radius: 0; text-align: center;">
            ...
            <h2 style="font-size: 24px; color: #0f172a; margin-bottom: 12px; font-family: var(--font-heading);">Join the CliftonAI Hub</h2>
...
<?php wp_footer(); ?>
<?php echo clifton_get_theme_mod( 'clifton_footer_scripts' ); ?>
</body>
</html>
