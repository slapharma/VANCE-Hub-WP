<?php
/**
 * Template Name: AI Maturity Quiz
 */

// Get saved quiz answers for logged-in users to pre-populate
$saved_quiz = array();
if ( is_user_logged_in() ) {
    $meta = get_user_meta( get_current_user_id(), '_clifton_healthcare_quiz_results', true );
    if ( is_array( $meta ) ) {
        $saved_quiz = $meta;
    }
}
        ...
        <form id="health-quiz-form">
            ...
            <div class="results-screen" id="results-screen">
                ...
                <div class="register-cta">
                    ...
                    <?php else : ?>
                        <h3>Join the Clifton Community</h3>
                        <p>Register for free today to access all the CliftonAI tools, clinical trackers, and your personalized dashboard.</p>
