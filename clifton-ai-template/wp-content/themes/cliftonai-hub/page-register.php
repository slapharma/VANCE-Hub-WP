...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['clifton_register_submit'])) {
    $errors = array();
    
    // Verify nonce
    if (!isset($_POST['clifton_register_nonce']) || !wp_verify_nonce($_POST['clifton_register_nonce'], 'clifton_register_action')) {
...
<div class="clifton-register-page">
    <div class="register-container">
        <div class="register-header">
            <div class="register-logo">S</div>
            <h1 class="register-title">Create Your Account</h1>
            <p class="register-subtitle">Join the CliftonAI community today</p>
        </div>
        ...
        <form method="POST" action="">
            <?php wp_nonce_field('clifton_register_action', 'clifton_register_nonce'); ?>
            ...
            <button type="submit" name="clifton_register_submit" class="submit-btn">Create Account</button>
        </form>
