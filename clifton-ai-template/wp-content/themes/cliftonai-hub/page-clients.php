...
<main id="main-content">
    ...
    <!-- HERO SECTION -->
    <?php
    $hero_bg    = clifton_get_theme_mod( 'clifton_pat_hero_bg', get_template_directory_uri() . '/assets/img/patient_hero.png' );
    $hero_tag   = clifton_get_theme_mod( 'clifton_pat_hero_tag',   'Patient Portal' );
    $hero_title = clifton_get_theme_mod( 'clifton_pat_hero_title', 'Empowering Your <span class="highlight">Wellness Journey</span>' );
    $hero_desc  = clifton_get_theme_mod( 'clifton_pat_hero_desc',  'More than just a news site—a truly useful platform providing the highest quality clinical information, innovative tools, and expert opinions to help you explore and manage your gastro healthcare concerns.' );
    ?>
    ...
    <!-- BENEFITS SECTION -->
    <?php
    $ben_tag   = clifton_get_theme_mod( 'clifton_pat_ben_tag',   'Why Choose CliftonAI?' );
    $ben_title = clifton_get_theme_mod( 'clifton_pat_ben_title',  'Not Just Another Community' );
    $ben_desc  = clifton_get_theme_mod( 'clifton_pat_ben_desc',  'CliftonAI is a comprehensive suite of resources designed to aid your personal health journey. We bridge the gap between complex medical research and practical, daily wellness by providing clinical information in a format that is easy to understand.' );
    ...
    <section id="benefits" class="section-padding" style="background: white;">
        <div class="container">
            ...
            <div class="grid-3 benefit-grid margin-b-60">
                <?php for ( $i = 1; $i <= 3; $i++ ) :
                    $ben_t = clifton_get_theme_mod( "clifton_pat_ben{$i}_title", $ben_defaults[ $i ][0] );
                    $ben_d = clifton_get_theme_mod( "clifton_pat_ben{$i}_desc",  $ben_defaults[ $i ][1] );
                ?>
    ...
    <!-- TOOLS SECTION -->
    <?php
    $tool_title = clifton_get_theme_mod( 'clifton_pat_tool_title', 'Innovative Tools at Your Fingertips' );
    $tool_defaults = array(
    ...
    <section class="section-padding" style="background: var(--accent-color);">
        <div class="container">
            ...
            <div class="grid-3">
                <?php for ( $i = 1; $i <= 6; $i++ ) :
                    $t_title = clifton_get_theme_mod( "clifton_pat_tool{$i}_title", $tool_defaults[ $i ][0] );
                    $t_desc  = clifton_get_theme_mod( "clifton_pat_tool{$i}_desc",  $tool_defaults[ $i ][1] );
                ?>
    ...
    <!-- CTA SECTION -->
    <?php
    $cta_title = clifton_get_theme_mod( 'clifton_pat_cta_title', 'Begin Your Journey' );
    $cta_desc  = clifton_get_theme_mod( 'clifton_pat_cta_desc',  "Join thousands of patients taking control of their gut health and longevity. It's completely free to start using our clinical resources today." );
    ?>
