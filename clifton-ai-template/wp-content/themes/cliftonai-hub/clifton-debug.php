<?php
/**
 * Clifton Debug - REMOVE AFTER USE
 * Access: https://www.cliftonai.com/wp-content/themes/cliftonai-hub/clifton-debug.php
 */
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);

echo '<h1>Clifton Debug File - PHP is working</h1>';
