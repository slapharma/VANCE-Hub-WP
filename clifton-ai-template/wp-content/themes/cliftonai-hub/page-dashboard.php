...
if ( isset($_GET['print_note']) && is_user_logged_in() ) {
    ...
    $my_notes = get_user_meta(get_current_user_id(), '_clifton_user_notes', true) ?: array();
    $target_note = null;
    ...
    if($target_note) {
        ...
        <body onload="window.print()">
            <div class="header">
                <div class="logo-area">
                    <div class="logo">CliftonAI Hub</div>
...
<?php else : 
    ...
    $job_title = get_user_meta( $current_user->ID, '_clifton_job_title', true ) ?: 'Add Job Title';
    $org = get_user_meta( $current_user->ID, '_clifton_organization', true ) ?: 'Add Organization';
    $bookmarks = get_user_meta( $current_user->ID, '_clifton_reading_list', true ) ?: array();
    ...
    <aside class="dash-sidebar" id="sidebar">
        <div class="sidebar-header">
            <a href="/" class="dash-logo" style="display: flex; align-items: center; gap: 0; text-decoration: none;">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png" alt="CliftonAI" style="height: 40px; width: auto; object-fit: contain;">
            </a>
        ...
        <div class="dash-content">
                ...
                <div>
                    ...
                    <p style="color:#64748B; margin:0;">
                        ...
                        switch($current_tab) {
                            ...
                            case 'ai-chats': echo 'History of your consultations with Clifton AI.'; break;
            ...
            <?php switch($current_tab) : 
                case 'home': ?>
                    ...
                    <div class="dash-grid-v2">
                        ...
                        <div class="d-card d-col-4">
                            ...
                            <div class="dash-list">
                                <?php 
                                $my_notes = get_user_meta($current_user->ID, '_clifton_user_notes', true) ?: array();
                                if(empty($my_notes)): ?>
                        ...
                        <div class="d-card d-col-4">
                            ...
                            <div style="text-align:center; padding:10px;">
                                <?php $high_score = get_user_meta($current_user->ID, '_clifton_high_score', true) ?: 0; ?>
                ...
                case 'profile': 
                    // Prepare data
                    $socials = array(
                        'website' => get_user_meta($current_user->ID, '_clifton_website', true),
                        'twitter' => get_user_meta($current_user->ID, '_clifton_twitter', true), // X
                        'linkedin' => get_user_meta($current_user->ID, '_clifton_linkedin', true),
                        'instagram' => get_user_meta($current_user->ID, '_clifton_instagram', true),
                        'facebook' => get_user_meta($current_user->ID, '_clifton_facebook', true),
                    );
                    $profile_docs = get_user_meta($current_user->ID, '_clifton_profile_docs', true) ?: array();
                    $profile_links = get_user_meta($current_user->ID, '_clifton_profile_links', true) ?: array();
                    // Pad links to 5
                    while(count($profile_links) < 5) $profile_links[] = '';
                    ?>
                    <div class="dash-card" style="max-width: 900px;">
                        <form id="profile-form-main">
                            <?php wp_nonce_field( 'clifton_dashboard_nonce', 'profile_nonce' ); ?>
                                ...
                                <div>
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 24px;">
                                        <div>
                                            ...
                                            <input type="text" name="clifton_job_title" value="<?php echo esc_attr($job_title); ?>" style="width:100%; padding:10px; border:1px solid #E2E8F0; border-radius:0;">
                                        </div>
                                        <div>
                                            <label style="display:block; margin-bottom:8px; font-size:13px; font-weight:600;">Organization</label>
                                            <input type="text" name="clifton_organization" value="<?php echo esc_attr($org); ?>" style="width:100%; padding:10px; border:1px solid #E2E8F0; border-radius:0;">
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 24px;">
                                        <div><input type="url" name="clifton_website" placeholder="Website URL" value="<?php echo esc_attr($socials['website']); ?>" style="width:100%; padding:8px; border:1px solid #E2E8F0; border-radius:0; font-size:13px;"></div>
                                        <div><input type="url" name="clifton_twitter" placeholder="X (Twitter) URL" value="<?php echo esc_attr($socials['twitter']); ?>" style="width:100%; padding:8px; border:1px solid #E2E8F0; border-radius:0; font-size:13px;"></div>
                                        <div><input type="url" name="clifton_linkedin" placeholder="LinkedIn URL" value="<?php echo esc_attr($socials['linkedin']); ?>" style="width:100%; padding:8px; border:1px solid #E2E8F0; border-radius:0; font-size:13px;"></div>
                                        <div><input type="url" name="clifton_instagram" placeholder="Instagram URL" value="<?php echo esc_attr($socials['instagram']); ?>" style="width:100%; padding:8px; border:1px solid #E2E8F0; border-radius:0; font-size:13px;"></div>
                                        <div><input type="url" name="clifton_facebook" placeholder="Facebook URL" value="<?php echo esc_attr($socials['facebook']); ?>" style="width:100%; padding:8px; border:1px solid #E2E8F0; border-radius:0; font-size:13px;"></div>
                                    </div>
                    ...
                    function uploadProfileDoc(input) {
                        if (input.files[0]) {
                            var fd = new FormData();
                            fd.append('action', 'clifton_upload_profile_doc');
                            fd.append('doc', input.files[0]);
                            fd.append('nonce', '<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>');
                            jQuery.ajax({
                    ...
                    function deleteProfileDoc(id) {
                        ...
                        jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', {
                            action: 'clifton_delete_profile_doc', id: id, nonce: '<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>'
                ...
                case 'clinical-profile':
                    $quiz_results = get_user_meta($current_user->ID, '_clifton_healthcare_quiz_results', true) ?: array();
                    $clinical_profile = get_user_meta($current_user->ID, '_clifton_clinical_profile', true) ?: array();
                        ...
                        <div class="dash-card">
                            ...
                            <div style="margin-top:30px; border-top:1px solid #E2E8F0; padding-top:20px;">
                                ...
                                <form id="dashboard-additional-details-form">
                                    <?php wp_nonce_field( 'clifton_dashboard_nonce', 'nonce' ); ?>
                                    <input type="hidden" name="action" value="clifton_save_clinical_profile">
                ...
                case 'records': ?>
                    <div class="dash-card">
                        ...
                        <?php 
                        $posters = get_user_meta($current_user->ID, '_clifton_posters', true) ?: array();
                        if(empty($posters)): ?>
                    ...
                    <!-- AI Readiness Assessment Analyzer -->
                    <style>
                    ...
                    <div class="bt-section-header">
                        <div class="bt-section-title">🩸 AI Readiness Assessment Analyser <span class="bt-section-badge">Clinical Tool</span></div>
                        <a href="/ai-readiness/" class="bt-tool-btn" style="font-size:11px;">Open Full Page →</a>
                    </div>
                    <div class="bt-tool-card">
                        <div class="bt-tool-bar">
                            <div class="bt-tool-bar-left">
                                ...
                                <div>
                                    <div class="bt-tool-name">IBD AI Readiness Assessment Analyser</div>
                                    <div class="bt-tool-sub">CliftonAI · Precision Diagnostics</div>
                                </div>
                            </div>
                        ...
                        <iframe id="bt-iframe" class="bt-iframe" src="<?php echo get_template_directory_uri(); ?>/assets/tools/ai-readiness/index.html" loading="lazy" title="AI Readiness Assessment Analyser" allow="clipboard-write"></iframe>
                    </div>
                <?php break;
                ...
                case 'calculators': ?>
                    ...
                    <div class="calc-grid">
                        ...
                        <div class="calc-card">
                            ...
                            <div class="calc-card-body">
                                ...
                                <div class="calc-card-actions">
                                    <button class="calc-btn-launch primary" onclick="openCalcPopup('roi-calculator', 'IBD ROI Calculator', 'malnutrition')">
                                        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
                                        Launch Calculator
                                    </button>
                            ...
                            <div class="calc-popup-toolbar">
                                <div class="popup-tool-left">
                                    ...
                                    <div>
                                        ...
                                        <div class="popup-tool-sub">CliftonAI · Precision Diagnostics</div>
                                    </div>
                                </div>
                    ...
                    <script>
                    var calcNonce = '<?php echo wp_create_nonce('clifton_dashboard_nonce'); ?>';
                    var ajaxUrl   = '<?php echo admin_url('admin-ajax.php'); ?>';
                    var tplDir     = '<?php echo get_template_directory_uri(); ?>';

                    function openCalcPopup(toolSlug, title, type) {
                        var icons = { 'roi-calculator':'🍎', 'omega-3-calculator':'🐟' };
                        var pages = { 'roi-calculator':'/roi-calculator/', 'omega-3-calculator':'/omega-3-calculator/' };
                    ...
                    window.addEventListener('message', function(e) {
                        if (!e.data || e.data.type !== 'CLIFTONAI_SAVE_ROI_RESULT') return;
                        var r = e.data;
                        jQuery.post(ajaxUrl, {
                            action: 'clifton_save_calc_result',
                            nonce:  calcNonce,
                            tool:   'malnutrition',
                            result_id:   r.id,
                            score:       r.score,
                    ...
                    function openResultsModal(type) {
                        var titles = { malnutrition: 'ROI Calculator — Results', omega: 'Omega-3 Calculator — Results' };
                        ...
                        document.body.style.overflow = 'hidden';
                        jQuery.post(ajaxUrl, { action: 'clifton_get_calc_results', nonce: calcNonce, tool: type }, function(res) {
                ...
                case 'searches': ?>
                    <div class="dash-card">
                        <?php 
                        $searches = get_user_meta($current_user->ID, '_clifton_saved_searches', true) ?: array();
                        if(empty($searches)): ?>
                             <div style="text-align:center; padding:48px; background:#F8FAFC; border:1px dashed #E2E8F0; border-radius:0;">
                ...
                case 'ai-chats': ?>
                    <div class="dash-card">
                         <?php 
                         $ai_chats = get_user_meta($current_user->ID, '_clifton_saved_chats', true);
                         ...
                         <?php else: ?>
                             ...
                             <script>
                                ...
                                function renameChat(id, currentTitle) {
                                    ...
                                    jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', {
                                        action: 'clifton_rename_chat',
                                        id: id,
                                        title: newTitle.trim(),
                                        nonce: '<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>'
                                    }, function(res) {
                                        if(res.success) {
                                            location.reload();
                                        } else {
                ...
                case 'high-score': ?>
                    <div class="dash-grid-v2">
                        <div class="d-card d-col-8">
                            <div style="text-align:center; padding:48px; background:#F0F9FF; border:1px dashed #BAE6FD; border-radius:0;">
                                <h3 style="color:#0F172A; margin:0 0 10px 0;">Gamification Placeholder</h3>
                                <p style="color:#64748B; max-width:520px; margin:0 auto;">Embed an interactive demo, AI challenge, or product walkthrough here. Replace this block in <code>page-dashboard.php</code> (case <code>'high-score'</code>) with your own iframe or React widget.</p>
                            </div>
                        </div>
                        <div class="d-card d-col-4">
                            <div class="d-card-header">
                            ...
                            <div style="font-size:13px; color:#64748B; background:#F8FAFC; padding:12px; border-radius:0; text-align:center;">
                                ...
                                <?php 
                                $leaderboard = get_option('clifton_game_leaderboard', array());
...
<script>
    ...
    window.addEventListener('message', function(e) {
        if(e.data.type === 'GAME_SCORE') {
            // Save Score
            jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', {
                action: 'clifton_save_game_score',
                score: e.data.score,
                nonce: '<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>'
            }, function(res) {
                if(res.success) {
    ...
    function switchRole(role) {
        jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', {
            action: 'clifton_switch_role', role: role, nonce: '<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>'
        }, function(res) {
    ...
    function uploadPoster(input) {
        if (input.files[0]) {
            var fd = new FormData();
            fd.append('action', 'clifton_upload_poster');
    ...
    function deletePoster(id) {
         ...
         jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', {
            action: 'clifton_delete_poster', id: id, nonce: '<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>'
        }, function(res) { if(res.success) location.reload(); else alert(res.data); });
    }
    ...
    function deleteBookmark(pid) {
        ...
        jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', {
            action: 'clifton_toggle_bookmark', post_id: pid, nonce: '<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>'
    ...
    function deleteNote(id) {
        ...
        // Re-using clifton_save_note with empty content or similar? 
        // Better to add a proper delete action in functions.php if not exists.
        // For now, let's assume clifton_delete_note exists or use clifton_save_note with a flag.
        jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', {
            action: 'clifton_delete_note', id: id, nonce: '<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>'
        }, function(res) { if(res.success) location.reload(); else alert(res.data); });
    }
    ...
    function deleteSearch(id) {
        ...
        jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', {
            action: 'clifton_delete_search', id: id, nonce: '<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>'
        }, function(res) { if(res.success) location.reload(); else alert(res.data); });
    }
    ...
    function uploadAvatar(input) {
        if (input.files[0]) {
            var fd = new FormData();
            fd.append('action', 'clifton_upload_avatar');
    ...
    jQuery(document).on('submit', '#profile-form-main', function(e) {
        e.preventDefault();
        var data = jQuery(this).serialize() + '&action=clifton_save_profile&nonce=<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>';
    ...
    function deleteChat(id) {
        ...
        jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', {
            action: 'clifton_delete_chat', id: id, nonce: '<?php echo wp_create_nonce("clifton_dashboard_nonce"); ?>'
        }, function(res) { if(res.success) location.reload(); else alert(res.data); });
    }
</script>
