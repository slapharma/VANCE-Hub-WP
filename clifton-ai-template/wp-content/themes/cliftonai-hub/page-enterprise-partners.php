<?php
/**
 * Template Name: Enterprise Partners
 */
get_header(); ?>
...
<main id="main-content">
    ...
    <!-- HERO SECTION -->
    <?php
    $hero_bg    = clifton_get_theme_mod( 'clifton_hcp_hero_bg', get_template_directory_uri() . '/assets/img/hcp_hero.png' );
    $hero_tag   = clifton_get_theme_mod( 'clifton_hcp_hero_tag', 'Professional Portal' );
    $hero_title = clifton_get_theme_mod( 'clifton_hcp_hero_title', 'Advancing <span class="highlight">Clinical Practice</span> Through Nutrition' );
    $hero_desc  = clifton_get_theme_mod( 'clifton_hcp_hero_desc', 'Evidence-based resources, clinical protocols, and CME opportunities designed for gastroenterologists, dietitians, GPs, and allied health professionals.' );
    ?>
    ...
    <!-- RESOURCES SECTION -->
    <?php
    $res_tag   = clifton_get_theme_mod( 'clifton_hcp_res_tag',   'Join the Effort' );
    $res_title = clifton_get_theme_mod( 'clifton_hcp_res_title',  "What You'll Access" );
    $res_desc  = clifton_get_theme_mod( 'clifton_hcp_res_desc',  'We invite passionate healthcare practitioners to join us in advancing clinical nutrition. Share your expertise and help shape the future of specialized healthcare content.' );
    ...
    <section id="resources" class="section-padding" style="background: var(--accent-color);">
        <div class="container">
            ...
            <div class="grid-2 resource-grid">
                <?php for ( $i = 1; $i <= 4; $i++ ) :
                    $card_title = clifton_get_theme_mod( "clifton_hcp_res{$i}_title", $res_defaults[ $i ][0] );
                    $card_desc  = clifton_get_theme_mod( "clifton_hcp_res{$i}_desc",  $res_defaults[ $i ][1] );
                ?>
    ...
    <!-- COLLABORATE SECTION -->
    <?php
    $collab_title = clifton_get_theme_mod( 'clifton_hcp_collab_title', 'Collaborate with CliftonAI' );
    ...
    <section class="section-padding" style="background: white;">
        <div class="container">
            ...
            <div class="grid-4 service-grid">
                <?php for ( $i = 1; $i <= 4; $i++ ) :
                    $col_title = clifton_get_theme_mod( "clifton_hcp_col{$i}_title", $collab_defaults[ $i ][0] );
                    $col_desc  = clifton_get_theme_mod( "clifton_hcp_col{$i}_desc",  $collab_defaults[ $i ][1] );
                ?>
    ...
    <!-- REGISTER CTA -->
    <?php
    $cta_title = clifton_get_theme_mod( 'clifton_hcp_cta_title', 'Join the Professional Network' );
    $cta_desc  = clifton_get_theme_mod( 'clifton_hcp_cta_desc',  'Free registration gives you full access to protocols, research, and CME opportunities.' );
    ?>
