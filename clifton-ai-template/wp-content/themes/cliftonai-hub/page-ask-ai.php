...
$hero_bg = clifton_get_theme_mod('clifton_askai_hero_bg', get_template_directory_uri() . '/assets/img/about_hero.png');
$hero_title = clifton_get_theme_mod('clifton_askai_hero_title', 'Ask AI');
$hero_subtitle = clifton_get_theme_mod('clifton_askai_hero_subtitle', 'Direct access to our IBD Research Centre. Ask anything about IBD, clinical nutrition, and gastrointestinal health.');
$hero_badge = clifton_get_theme_mod('clifton_askai_hero_badge', 'Clinical Assistant v1.0');
        ...
        <main class="chat-main">
            ...
            <div class="chat-container">
                <div class="chat-widget-wrapper" style="display: flex; flex-direction: column; height: 100%;">
                    ...
                    <div class="chat-messages" id="clifton-ai-chat-messages" style="flex: 1; padding: 24px 32px; overflow-y: auto; background: white; max-height: 550px;">
                    ...
                    <div class="chat-input-bar" style="padding: 16px 32px; border-top: 1px solid #E2E8F0; display: flex; gap: 12px; background: white;">
                        <input type="text" id="clifton-ai-chat-input" class="chat-input" placeholder="Ask a question..." style="flex: 1; padding: 14px 20px; border: 2px solid #E2E8F0; border-radius: 0; font-size: 15px; outline: none; transition: 0.2s;">
                        <button class="chat-send" id="clifton-ai-chat-send" style="padding: 14px 28px; background: var(--primary-color); color: white; border: none; border-radius: 0; font-weight: 700; font-size: 15px; cursor: pointer; transition: 0.2s;">Send</button>
                    </div>
